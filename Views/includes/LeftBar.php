<div class="col-span-2 primary_bg_ h-screen overflow-y-auto border-gray-800 border-r">
    ...
    <div class="flex flex-col">
        ...
        <div data-path="/users" class="flex p-2 my-2 transition-all duration-500  text-gray-500 cursor-pointer bg-gradient-to-r hover:from-green-500 hover:to-gray-900 hover:text-white">
           <div class="w-11/12 mx-auto flex ">
        ...
        <div data-path="/bonus" class="flex p-2 my-2 transition-all duration-500  text-gray-500 cursor-pointer bg-gradient-to-r hover:from-green-500 hover:to-gray-900 hover:text-white">
           <div class="w-11/12 mx-auto flex ">
                <span class="w-2/12"><i class="fas fa-wind"></i></span> 
                <span class="w-10/12 mt-0.5">Bonus</span>
           </div>
        </div>
        ...
        <div data-path="/transactions" class="flex p-2 my-2 transition-all duration-500  text-gray-500 cursor-pointer bg-gradient-to-r hover:from-green-500 hover:to-gray-900 hover:text-white">
           <div class="w-11/12 mx-auto flex ">
                <span class="w-2/12"><i class="fas fa-exchange-alt"></i></span> 
                <span class="w-10/12 mt-0.5">Transactions</span>
           </div>
        </div>
        <div class="">
            <div></div>
