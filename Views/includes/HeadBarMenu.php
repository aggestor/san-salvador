<div class="w-full flex sticky top-0 justify-between h-14 items-center p-2 w-full border-b border-gray-800">
    ...
    <div class="w-5/12">
        <div class="w-10/12 mx-auto focus-within:font-semibold text-gray-300 focus-within:text-green-600 group focus-within:border-green-500 my-4 h-10 px-2 items-center flex rounded-full border border-gray-400">
            <i class="fas fa-time"></i>
            <input id="admin-search" placeholder="Rechercher bonus, utilisateurs, devises etc..." class="bg-transparent focus:text-green-500 focus:outline-none ml-2 w-full" autocomplete="on"/>
        </div>
    </div>
    <div class="w-5/12">
