<div class="col-span-12 mb-12 primary_bg grid place-items-center">
    <div class="md:w-6/12 lg:w-8/12 flex flex-col lg:flex-row justify-center items-center border mt-16 border-gray-900 mx-auto primary_bg_ shadow rounded md:p-12 p-4">
        <div class="md:w-10/12 w-11/12 lg:w-9/12  mx-auto md:p-3">
        ...
        <div class="lg:w-6/12 h-72 hidden lg:flex overflow-hidden items-center justify-center">
            <span class="h-60 w-60 text-gray-900 relative">
                <span class='w-40 h-40  rounded-full bg-gray-500 grid place-items-center'><i class="fa fa-sad-cry fa-6x"></i></span>
                <span class="w-28 h-28 border-4 absolute right-6 bottom-8 border-gray-900 rounded-full bg-gray-500 grid place-items-center text-6xl font-semibold">!</span>
            </span>
        </div>
    </div>
</div>