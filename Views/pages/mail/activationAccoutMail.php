                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        ...
                                        <a href="<?php echo $lien ?>"
                                            style="background:#1064ff;text-decoration:none !important; font-weight:500; margin-top:35px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 24px;display:inline-block;border-radius:50px;">Activer mon compte</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="height:40px;">&nbsp;</td>
