                    ...
                    <tr>
                        <td style="text-align:center;">
                            <a href="https://usalvagetrade.com" title="logo" target="_blank">
                                <img width="200" src="https://usalvagetrade.com/assets/logos/Logo-usalva-All-Face.png" title="logo" alt="logo">
                            </a>
                        </td>
                    </tr>
                    <tr>
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        ...
                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                            Salut <strong><?= $params['nom'] ?></strong>, vous nous avez demander une reinitialisation du mot de passe .<br>
                                        ...
                                        <a href="<?php echo $params['lien'] ?>" style="background:#1064ff;text-decoration:none !important; font-weight:500; margin-top:35px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 24px;display:inline-block;border-radius:50px;">Reinitialiser mot de passe</a> <br>
