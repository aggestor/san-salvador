...
>>>>>>> bd11fb0b1fcf82bb8d007c6a6baf3f18ebd0944c
        ...
        <div class="lg:w-4/12 w-11/12 mx-auto lg:mx-0 mb-2 lg:mb-0 rounded border p-4 flex flex-col border-gray-900 h-80">
            ...
            <div class="w-full grid place-items-center my-3">
                <ul class="flex flex-col">
                    <li class="hover:text-green-500 p-2 text-gray-400"><a href="mailto:contact@uslavagetrade.com">contact@uslavagetrade.com</a></li>
        ...
        <div class="lg:w-4/12 w-11/12 mx-auto lg:mx-0 mb-2 lg:mb-0 rounded border p-4 flex flex-col border-gray-900 h-80">
            ...
            <div class="w-full grid place-items-center my-3">
                <ul class="flex flex-col">
                    <li class="hover:text-green-500 p-2 text-gray-400"><a class="flex w-full" href="https://www.facebook.com/UsalvageTrade/"><span class="mr-4 text-gray-500 grid place-items-center rounded-full"><i class="fab text-2xl fa-facebook"></i></span><span>Usalvatrade</span></a></li>
                    <li class="hover:text-green-500 p-2 text-gray-400"><a class="flex w-full" href="https://www.instagram.com/usalvage_trade/"><span class="mr-4 text-gray-500 grid place-items-center rounded-full"><i class="fab text-2xl fa-instagram"></i></span><span>Usalvagetrade</span></a></li>
                    <li class="hover:text-green-500 p-2 text-gray-400"><a class="flex w-full" href="https://bit.ly/3qaM9KV"><span class="mr-4 text-gray-500 grid place-items-center rounded-full"><i class="fab text-2xl fa-twitter"></i></span><span>uslavagetrade</span></a></li>
                    ...
                    <li class="hover:text-green-500 p-2 text-gray-400"><a class="flex w-full" href="https://wa.me/13236785503"><span class="mr-4 text-gray-500 grid place-items-center rounded-full"><i class="fab text-2xl fa-whatsapp"></i></span><span>+1 929-224-5034</span></a></li>
                </ul>
            </div>
        </div>
    </div>
