<div class="col-span-12 h-auto bg-secondary">
    <div class="flex flex-col w-11/12 mx-auto  h-auto md:items-center">
        ...
        <div class="w-full flex lg:flex-row flex-col lg:justify-around">
            <div class="lg:w-3/12 mx-auto w-11/12 hover:bg-opacity-50 duration-500 transition-all overflow-hidden m-4 primary_bg rounded-xl relative shadow border border-gray-100 h-96">
            ...
            <div class="lg:w-3/12 w-11/12 hover:bg-opacity-50 duration-500 transition-all overflow-hidden m-4 primary_bg rounded-xl relative shadow border border-gray-100 h-96">
            ...
            <div class="lg:w-3/12 w-11/12 hover:bg-opacity-50 duration-500 transition-all overflow-hidden m-4 primary_bg rounded-xl relative shadow border border-gray-100 h-96">
                <span class="w-full"><img src="/assets/logos/executium-GnWfl_nnZro-unsplash.jpg" alt="silver illustration" class="w-full z-0 object-cover h-40 mx-auto"></span>
                <div class="text-gray-400 p-2">
                    <div>
