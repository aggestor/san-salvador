    ...
    <div class="w-full h-20 flex flex-col items-center border-b border-gray-900">
        <div class="flex w-10/12 mx-auto mt-5">
            ...
            <a href="/" class=" cursor-pointer">
                <h1 class="text-gray-300 hover:text-green-500 font-bold text-xl text-left mx-a">USALVAGETRADE</h1>
            </a>
        </div>
    ...
    <div class="md:w-6/12 flex flex-col justify-center items-center border mt-16 border-gray-900 mx-auto primary_bg shadow rounded md:p-12 p-4">
        ...
        <form method="POST" class="md:w-10/12 w-11/12  mx-auto md:p-3">
            ...
            <div class="md:w-11/12 mx-auto mt-4">
                <button type="submit" name="edit" class="bg-green-500 text-gray-900 p-2 w-full h-10 rounded"><i class="fas fa-save"></i> Enregistrer</button>
            </div>
        </form>
    </div>
