    ...
    <div class="col-span-12 flex flex-col">
        <div class="w-11/12 mx-auto mb-4 h-12 border-b border-gray-900 flex justify-between">
            ...
            <div class="flex w-5/12 justify-between">
                ...
                <span id="btnBanedAdminSection" class="primary_bg_ rounded text-gray-300 hover:text-gray-900 font-semibold h-10 w-28 p-1 hover:bg-green-500 hover:bg-opacity-100 flex items-center justify-around cursor-pointer"><i class="fas fa-ban"></i> Desactivés</span>
                <span id="btnAddAdminSection" class="primary_bg_ rounded text-gray-300 hover:text-gray-900 font-semibold h-10 w-28 p-1 hover:bg-green-500 hover:bg-opacity-100 flex items-center justify-around cursor-pointer"><i class="fas fa-plus-circle"></i> Ajouter</span>
            </div>
        </div>
