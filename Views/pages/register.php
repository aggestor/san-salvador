    ...
    <div class="w-full flex justify-center flex-col primary_bg">
        ...
        <form method="POST" action="/sign_in" class="md:w-11/12 w-full  mx-auto">
            ...
            <div  class="w-full form-2 hidden flex-col mx-auto p-3">
                <div><div id="crop"></div></div>
                <div class="md:w-11/12 w-full flex justify-between mx-auto mt-4">
                    <button name="3" type="button" class="_green_bg form-user-btn text-gray-900 p-2 w-5/12 h-10 rounded"><i class="fas fa-arrow-down"></i> Suivant</button>
            ...
            <!---FORM PART 3-->
            <div class="w-full hidden form-3 flex-col mx-auto p-3">
