...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 06 jan. 2022 à 16:31
...
('8A1BeeBd5cE', 'CabA831C4Bd', 100, '2022-01-06', '16:12:22', 'Bitcoin', 'Btc', 0, NULL, NULL, NULL, NULL, NULL),
('aF3fe37Bc94', '842f4A38BF1', 120, '2022-01-06', '16:22:40', 'Bitcoin', 'Btc', 0, NULL, NULL, NULL, NULL, NULL),
('Bd4bCcA0fCa', '12c544e4b8d', 150, '2022-01-06', '16:16:49', 'Bitcoin', 'Btc', 0, NULL, NULL, NULL, NULL, NULL),
('E362Af20BEa', '8b1EFE2dFf0', 70, '2022-01-06', '16:08:16', 'Bitcoin', 'Btc', 0, NULL, NULL, NULL, NULL, NULL),
...
('bDbEdcBDd49', 'Usalvagetrade', NULL, 'usalvagetrade@gmail.com', '+243819953172', '$argon2i$v=19$m=65536,t=4,p=1$TEpYa0VGN1NOY1hPbXpCTg$O7WHEyMeECzhSTNsnecLJLCMLunMlYZCNbHFebtCEq0', '', 0, 1, 0, '2022-01-01', '10:00:00', NULL, NULL, NULL, NULL, ''),
...
--
ALTER TABLE `cashout`
  ADD CONSTRAINT `cashout_ibfk_1` FOREIGN KEY (`id`) REFERENCES `users` (`id`);
